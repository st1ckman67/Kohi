...
b8 platform_startup(
    ...
    i32 height) {
        ...
        // Loop through screen using iterator.
        ...
        // Allocate an XIB for the window to be created.
...
void platform_shutdown(platform_state* plat_state) {
    ...
    // Turn repeat keys back on since this is a global setting for this OS.
